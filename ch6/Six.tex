...
\noindent This expression can be significantly reduced by merging the arguments of the logarithms on either side of the equation into ratios:
...
\begin{equation}
p(i|a) \times p(i|d) \approx p(i|b) \times p(i|c)
\end{equation}
...
\begin{tikzpicture}[scale=0.5]
	...
	\addplot [mark=x,only marks,mark size = 2.5] coordinates {
...
\node [anchor=east] at (axis cs: 0.83647,0.3181,1.81529) {\small bus};
\node [anchor=west] at (axis cs: 1.05531,0.80923,2.01808) {\small motorcycle};
\node [anchor=east] at (axis cs: 3.32574,1.74923,3.24988) {\small sofa};
\node [anchor=north] at (axis cs: 3.5408,2.23614,3.46375) {\small stool};
%\addplot3 [color=black,->,ultra thick] coordinates {(2.2,2.2,2.2) (4,4,4)};
\end{axis}
\end{tikzpicture}
\caption*{\textsc{furniture} $\Longleftrightarrow$ \textsc{vehicles}}
...
\hline
\parbox[t]{2mm}{\multirow{4}{*}{\rotatebox[origin=c]{90}{\textsc{ 5x5}}}} & \textsc{joint} & 0.941 & 0.987 & 0.996 & 0.997 & 0.995 & 0.957 \\
...
\begin{figure}
\begin{tikzpicture}
\begin{axis}[scatter/classes={x={mark=x,draw=black},o={mark=o,draw=gray}},mark options={xscale=0.5},xmode=log,ymode=log,xscale = 2,xlabel=\emph{joint non-zero dimension count},ylabel=\emph{independent non-zero dimension count},tick style={draw=none}]
