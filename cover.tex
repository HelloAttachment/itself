...
\item[co-occurrence] The observation of one word being situated in proximity to another in a corpus.
...
\item[model] An application of methodology to a particular linguistic task or experiment, often complemented by additional statistical analysis techniques.
