...
The really remarkable outcome here, though, is the very strong performance of the models learned from the top seven and nine features extracted from subspaces selected by PMI values of the adjective word-vectors alone, though.  This is particularly interesting given that the data being tested here actually consists of a different type of grammatical relationship, namely, predicate-object pairs.  It would seem, then, that the geometry 
...
\multicolumn{2}{c}{\textsc{joint}} & \multicolumn{2}{c}{\textsc{indy}} & \multicolumn{2}{c}{\textsc{zipped}} \\
\hline
$\mu(\overline{A'C'},\overline{B'C'}$ & 0.544 & $\angle ACB$ & 0.506 & $\overline{AB}/C$ & 0.371 \\
$\mu(\overline{AB}/C$ & 0.536 & $\angle AOB$ & 0.504 & $\angle AXB$ & 0.356 \\
$\mu(\overline{A'X'},\overline{B'X'}$ & 0.533 & $\mu(\overline{A'X'},\overline{B'X'}$ & 0.482 & $\overline{AB}$ & 0.312 \\
$\angle AOB$ & 0.524 & $\overline{AB}/C$ & 0.481 & $\angle AOB$ & 0.312 \\
$\mu(\overline{A'M'},\overline{B'M'}$ & 0.503 & $\mu(\overline{A'C'},\overline{B'C'})$ & 0.476 & $\mu(\overline{A'C'},\overline{B'C'})$ & 0.306 \\
\hline
\end{tabular}
\vfill
\begin{tabular}{lr|lr}
...
\hline
$A:B$ & 0.504 & $A:B$ & 0.553 \\
$\overline{A'X'}:\overline{B'X'}$ & 0.445 & $A/B$ & 0.553 \\
$\overline{A'X'}/\overline{B'X'}$ & 0.445 & $\mu(\overline{AB}/C$ & 0.487 \\
$\mu(\overline{A'M'},\overline{B'M'}$ & 0.406 & $\angle AMB$ & 0.461 \\
$A/B$ & 0.379 & $\angle ACB$ & 0.416 \\
\hline
\end{tabular}
\caption[Top Independent Features for Coercion Classification]{Independent f-scores from the coercion classification data for top five features of each subspace type for 2x2 word co-occurrence window, 400 dimension subspaces.}
\label{tab:ind-coercion}
\end{table}

%('0.654', [('mAMB', '2.193'), ('fABM', '-1.438'), ('aMOX', '0.395'), ('fACB', '-0.201'), ('X', '-0.851'), ('mAXB', '0.973'), ('eAXB', '0.155')])

%('0.682', [('mAOB', '2.154'), ('fCX', '-1.940'), ('rAOB', '0.304'), ('nAMB', '-0.260'), ('eACB', '-0.207'), ('qACB', '0.382'), ('qAMB', '-0.046')])

%('0.693', [('C', '2.843'), ('mAOB', '-2.402'), ('lAMB', '1.352'), ('mAXB', '-0.037'), ('eAXB', '0.132'), ('fAMB', '-0.770'), ('rACB', '0.087')])

\begin{table}
\centering
\begin{tabular}{llr}
\hline
& \multicolumn{1}{c}{\textsc{indy} ($f = 0.682$)} & \multicolumn{1}{c}{verb ($f = 0.693$)} \\
\hline
& \multicolumn{2}{c}{\textsc{distances}} \\
word-vectors & - & - \\
generic vectors & - & $2.843 = C$ \\
\hline
& \multicolumn{2}{c}{\textsc{angles}} \\
word-vectors & - & - \\
normalised & $\angle A'M'B' = -0.260$ \\
generic & - & - \\
\hline
& \multicolumn{2}{c}{\textsc{means}} \\
word-vectors & $\mu(\overline{AO},\overline{BO}) = 2.154$ & $-2.402 = \mu(\overline{AO},\overline{BO})$ \\
& - & $-0.037 = \mu(\overline{AX},\overline{BX}$ \\
normalised & - & $1.352 = \mu(\overline{A'M'},\overline{B'M'})$ \\
\hline
& \multicolumn{2}{c}{\textsc{ratios}} \\
word-vectors & $A:B = 0.304$ & $0.087 = \overline{AC}:\overline{BC}$ \\
normalised & $\overline{A'C'}:\overline{B'C'} = 0.382$ & - \\
& $\overline{A'M'}:\overline{B'M'} = -0.046$ \\
\hline
& \multicolumn{2}{c}{\textsc{fractions}} \\
word-vectors & - & $-0.770 = \overline{AM}/\overline{BM}$ \\
normalised & $\overline{A'C'}/\overline{B'C'} = -0.207$ & - \\
generic vectors & $C/X = -1.940$ & $0.132 = \overline{AX}/\overline{BX}$ \\
\hline
\end{tabular}
\caption{Comparison of the seven most effective features for coercion classification in \textsc{indy} 2x2 word, 400 dimensional subspaces for \textsc{indy} versus verb based dimension selection in .}
\label{tab:features}
\end{table}
