...
\res{Done!  (For instances where I compare categorically across different parameters; for instances where I compare singular results from other studies, scores are generally listed in order.)}
